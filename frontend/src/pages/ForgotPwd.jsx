    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-lg space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-zinc-500">We'll send a recovery link to your inbox</p>
        </div>
        ...
        <Card className="p-8 space-y-6 shadow-premium">
          ...
          <Link to="/login" className="flex items-center justify-center gap-2 text-sm font-bold text-zinc-500 hover:text-white transition-colors">
